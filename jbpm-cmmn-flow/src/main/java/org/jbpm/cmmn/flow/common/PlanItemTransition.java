...
public enum PlanItemTransition {
	CLOSE, COMPLETE, CREATE, DISABLE, ENABLE, EXIT,  FAULT, MANUAL_START, OCCUR, PARENT_RESUME, PARENT_SUSPEND,PARENT_TERMINATE, REACTIVATE, REENABLE, RESUME, START,STOP, SUSPEND, TERMINATE;
