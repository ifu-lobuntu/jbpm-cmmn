 ...
 * <ul>
 *   <li>{@link org.eclipse.cmmn1.impl.TRepetitionRuleImpl#getCondition <em>Condition</em>}</li>
 *   <li>{@link org.eclipse.cmmn1.impl.TRepetitionRuleImpl#getContextRef <em>Context Ref</em>}</li>
 *   <li>{@link org.eclipse.cmmn1.impl.TRepetitionRuleImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
    ...
    public TCaseFileItem getContextRef() {
        if (contextRef != null && contextRef.eIsProxy()) {
            ...
            if (contextRef != oldContextRef) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, Cmmn1Package.TREPETITION_RULE__CONTEXT_REF, oldContextRef, contextRef));
            }
        }
        return contextRef;
    }
