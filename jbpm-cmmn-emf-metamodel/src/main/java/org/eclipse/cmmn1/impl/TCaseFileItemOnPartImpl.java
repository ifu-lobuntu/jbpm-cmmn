 ...
 * <ul>
 *   <li>{@link org.eclipse.cmmn1.impl.TCaseFileItemOnPartImpl#getStandardEvent <em>Standard Event</em>}</li>
 *   <li>{@link org.eclipse.cmmn1.impl.TCaseFileItemOnPartImpl#getSourceRef <em>Source Ref</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
    ...
    public TCaseFileItem getSourceRef() {
        if (sourceRef != null && sourceRef.eIsProxy()) {
            ...
            if (sourceRef != oldSourceRef) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, Cmmn1Package.TCASE_FILE_ITEM_ON_PART__SOURCE_REF, oldSourceRef, sourceRef));
            }
        }
        return sourceRef;
    }
