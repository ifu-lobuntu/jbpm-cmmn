 ...
 * <ul>
 *   <li>{@link org.eclipse.dd.cmmn.di.impl.DiagramImpl#getDocumentation <em>Documentation</em>}</li>
 *   <li>{@link org.eclipse.dd.cmmn.di.impl.DiagramImpl#getOwnedStyle <em>Owned Style</em>}</li>
 *   <li>{@link org.eclipse.dd.cmmn.di.impl.DiagramImpl#getRootElement <em>Root Element</em>}</li>
 *   <li>{@link org.eclipse.dd.cmmn.di.impl.DiagramImpl#getId <em>Id</em>}</li>
 *   <li>{@link org.eclipse.dd.cmmn.di.impl.DiagramImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.eclipse.dd.cmmn.di.impl.DiagramImpl#getResolution <em>Resolution</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class DiagramImpl extends MinimalEObjectImpl.Container implements Diagram {
    ...
    public NotificationChain basicSetRootElement(DiagramElement newRootElement, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, DiPackage.DIAGRAM__ROOT_ELEMENT, oldRootElement, newRootElement);
    ...
    public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
        switch (featureID) {
            case DiPackage.DIAGRAM__ROOT_ELEMENT:
                if (rootElement != null)
                    msgs = ((InternalEObject)rootElement).eInverseRemove(this, DiPackage.DIAGRAM_ELEMENT__OWNING_DIAGRAM, DiagramElement.class, msgs);
