...
import org.eclipse.dd.color.color.ColorFactory;
import org.eclipse.dd.color.color.ColorPackage;
import org.eclipse.dd.color.color.DocumentRoot;
import org.eclipse.dd.color.color.util.ColorValidator;
...
public class ColorPackageImpl extends EPackageImpl implements ColorPackage {
     ...
     * @see org.eclipse.dd.color.color.ColorPackage#eNS_URI
     * @see #init()
     * @generated
     */
    ...
    public void initializePackageContents() {
        ...
        initEAttribute(getDocumentRoot_FontSize(), theXMLTypePackage.getIntObject(), "fontSize", null, 0, 1, null, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
