 ...
 * <ul>
 *   <li>{@link org.omg.cmmn1.impl.TImportImpl#getImportType <em>Import Type</em>}</li>
 *   <li>{@link org.omg.cmmn1.impl.TImportImpl#getLocation <em>Location</em>}</li>
 *   <li>{@link org.omg.cmmn1.impl.TImportImpl#getNamespace <em>Namespace</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TImportImpl extends MinimalEObjectImpl.Container implements TImport {
	...
	protected EClass eStaticClass() {
		return Cmmn1Package.Literals.TIMPORT;
	}
	...
	public void setImportType(String newImportType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Cmmn1Package.TIMPORT__IMPORT_TYPE, oldImportType, importType));
	}
	...
	public void setLocation(String newLocation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Cmmn1Package.TIMPORT__LOCATION, oldLocation, location));
	}
	...
	public void setNamespace(String newNamespace) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Cmmn1Package.TIMPORT__NAMESPACE, oldNamespace, namespace));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Cmmn1Package.TIMPORT__IMPORT_TYPE:
				return getImportType();
			case Cmmn1Package.TIMPORT__LOCATION:
				return getLocation();
			case Cmmn1Package.TIMPORT__NAMESPACE:
				return getNamespace();
		}
