 ...
 * <ul>
 *   <li>{@link org.omg.cmmn1.impl.TStageImpl#getPlanningTable <em>Planning Table</em>}</li>
 *   <li>{@link org.omg.cmmn1.impl.TStageImpl#getPlanItemDefinitionGroup <em>Plan Item Definition Group</em>}</li>
 *   <li>{@link org.omg.cmmn1.impl.TStageImpl#getPlanItemDefinition <em>Plan Item Definition</em>}</li>
 *   <li>{@link org.omg.cmmn1.impl.TStageImpl#isAutoComplete <em>Auto Complete</em>}</li>
 *   <li>{@link org.omg.cmmn1.impl.TStageImpl#getExitCriteriaRefs <em>Exit Criteria Refs</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
