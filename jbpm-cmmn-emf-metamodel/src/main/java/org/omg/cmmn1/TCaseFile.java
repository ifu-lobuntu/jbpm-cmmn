 ...
 * <ul>
 *   <li>{@link org.omg.cmmn1.TCaseFile#getCaseFileItem <em>Case File Item</em>}</li>
 * </ul>
 * </p>
 *
 * @see org.omg.cmmn1.Cmmn1Package#getTCaseFile()
...
public interface TCaseFile extends TCmmnElement {
	 ...
	 * @see org.omg.cmmn1.Cmmn1Package#getTCaseFile_CaseFileItem()
