 ...
 * <ul>
 *   <li>{@link org.omg.cmmn1.TPlanningTable#getTableItemGroup <em>Table Item Group</em>}</li>
 *   <li>{@link org.omg.cmmn1.TPlanningTable#getTableItem <em>Table Item</em>}</li>
 *   <li>{@link org.omg.cmmn1.TPlanningTable#getApplicabilityRule <em>Applicability Rule</em>}</li>
 * </ul>
 * </p>
 *
 * @see org.omg.cmmn1.Cmmn1Package#getTPlanningTable()
...
public interface TPlanningTable extends TTableItem {
	 ...
	 * @see org.omg.cmmn1.Cmmn1Package#getTPlanningTable_TableItemGroup()
	 ...
	 * The list contents are of type {@link org.omg.cmmn1.TTableItem}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see org.omg.cmmn1.Cmmn1Package#getTPlanningTable_TableItem()
	 ...
	 * The list contents are of type {@link org.omg.cmmn1.TApplicabilityRule}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see org.omg.cmmn1.Cmmn1Package#getTPlanningTable_ApplicabilityRule()
